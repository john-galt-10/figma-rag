...
- Whenever adding new features or making significant changes prompt me whether we should update the "Current Milestone" section in the README.md of the repo